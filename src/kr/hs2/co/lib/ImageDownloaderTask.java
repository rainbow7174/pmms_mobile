...
import kr.hs2.co.lib.ImageDownloader.DownloadedDrawable;
...
public class ImageDownloaderTask extends AsyncTask<String, Void, Bitmap>
{
	...
	static Bitmap downloadBitmap(String url, String width, String height)
	{
...
//					final Bitmap bitmap = BitmapFactory.decodeStream(new FlushedInputStream(inputStream));
					...
					final Bitmap resized = Bitmap.createScaledBitmap(bitmap, Integer.parseInt(width), Integer.parseInt(height), true);
