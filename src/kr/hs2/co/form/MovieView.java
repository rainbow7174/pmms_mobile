...
//		Log.v("Tag", "IDX : " + idx);
	...
	private View.OnClickListener on_play = new View.OnClickListener() {
		@Override
		public void onClick(View v) {
			Intent intent = new Intent(MovieView.this,MoviePlayer.class);
...
//			AlertDialog.Builder ab = new AlertDialog.Builder(MovieView.this);
//			ab.setMessage(Html.fromHtml("속도문제로 잠시 점검중 입니다.<br><br>Comming Soon !!"));
...
//			ab.show();
	...
	private void searchXml(String idx){
		...
		String m_sConnectUrl = ServerUrl + "/movie_data_view.asp?idx="+idx;
...
//						xmlData = null;
	...
	class DownloadFile extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... url) {
			...
			try {
//				Log.v("Tag","fileurl : " + url[0]);
				
				URL fileurl = new URL(url[0]);
//				URL fileurl = new URL("http://172.168.10.100/upload/photo/oImg/201103/1820110327.jpg");
...
//				Log.v("Tag","lengthOfFile : " + String.valueOf(lengthOfFile));
				
				byte[] data = new byte[1024];
				String filename = Environment.getExternalStorageDirectory() + "/" + xmlData.getFilename();
//				String filename = Environment.getExternalStorageDirectory() + "/1820110327.jpg";
